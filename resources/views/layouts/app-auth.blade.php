...
<head>
    ...
    <title>NAJ Inventory - @yield('title')</title>
...
<body id="kt_body" class="auth-bg bgi-size-cover bgi-attachment-fixed bgi-position-center bgi-no-repeat">
    ...
    <div class="d-flex flex-column flex-root">
        ...
        <div class="d-flex flex-column flex-column-fluid flex-lg-row-reverse">
            <!--begin::Aside-->
            <div class="px-10 bg-white d-flex px-lg-15 pt-15 pt-lg-0">
                <!--begin::Aside-->
            ...
            <div class="order-1 d-flex flex-lg-row-fluid w-lg-50 order-lg-2">
                <div class="px-5 d-flex flex-column flex-center py-7 py-lg-15 px-md-15 w-100">
                    <div class="row g-5 g-xl-8" style="z-index: 10;">
                    </div>
                </div>
                <!--end::Aside-->
            </div>
